                    ...
                    <div className="p-6 md:p-12 max-w-6xl 2xl:max-w-7xl mx-auto pb-32">
                                ...
                                <div>
                                    ...
                                    <div className="flex gap-2">
                                        <input 
                                            ...
                                            className="flex-1 min-w-0 bg-white shadow-sm border border-slate-300 rounded-2xl px-6 py-4 focus:border-orange-500 transition-all outline-none text-zinc-900 font-medium text-sm"
                                        />
                                        <div className="shrink-0 flex">
                                            ...
                                            <label htmlFor="logo-upload" className={`cursor-pointer flex items-center justify-center px-4 py-4 rounded-2xl font-black uppercase tracking-widest transition-all text-[10px] border ${isUploadingStandby.logo ? 'bg-white shadow-sm border-slate-300 text-zinc-500' : 'bg-white shadow-sm hover:bg-slate-100 border-slate-300 text-zinc-900 shadow-xl hover:scale-105 active:scale-95'}`}>
                        ...
                        <div className="bg-white shadow-sm border border-slate-200 p-6 lg:p-8 rounded-3xl shadow-2xl mb-12 flex flex-col lg:flex-row gap-6 items-center">
                            <div className="flex-1 w-full">
                                ...
                                <input 
                                    ...
                                    className="w-full bg-white shadow-sm border border-slate-300 rounded-2xl px-6 py-4 focus:border-orange-500 transition-all outline-none text-zinc-900 font-medium text-sm"
                                />
                                ...
                                <div className="mt-4 flex flex-col sm:flex-row gap-4 items-start sm:items-center">
                                    <div className="flex-1 w-full">
                                        ...
                                        <div className="flex items-center gap-3">
                                            ...
                                            />
                                            <span className="text-xs font-mono font-bold bg-white shadow-sm px-3 py-1.5 rounded-lg text-zinc-900 border border-slate-200 w-16 text-center">
                                                {tickerSpeed}s
                                            </span>
                                        </div>
                                ...
                                <div className="mt-6 grid grid-cols-1 sm:grid-cols-2 gap-4 border-t border-slate-200 pt-4">
                                    <div>
                                        ...
                                        <select 
                                            ...
                                            className="w-full bg-white shadow-sm border border-slate-300 rounded-2xl px-6 py-4 focus:border-orange-500 transition-all outline-none text-zinc-900 font-semibold text-sm cursor-pointer appearance-none"
                                        >
                                ...
                                <div className="mt-6 border-t border-slate-200 pt-4">
                                    ...
                                    <div className="flex flex-col sm:flex-row gap-6 items-start sm:items-center">
                                        <select 
                                            ...
                                            className="flex-1 w-full bg-white shadow-sm border border-slate-300 rounded-2xl px-6 py-4 focus:border-orange-500 transition-all outline-none text-zinc-900 font-semibold text-sm cursor-pointer appearance-none"
                                        >
                                        ...
                                        <div className="flex items-center gap-6 p-4 bg-slate-100 rounded-2xl border border-slate-200 w-full sm:w-auto">
                                            <label className="flex items-center gap-2 cursor-pointer group">
                                                ...
                                                />
                                                <span className="text-xs font-bold text-zinc-600 group-hover:text-zinc-900 transition-colors">Notícias Ananás</span>
                                            </label>
                                            ...
                                            <label className="flex items-center gap-2 cursor-pointer group">
                                                <input 
                                                    ...
                                                    className="w-5 h-5 accent-orange-500 rounded bg-white shadow-sm border-slate-300 cursor-pointer"
                                                />
                                                <span className="text-xs font-bold text-zinc-600 group-hover:text-zinc-900 transition-colors">GE Esportes</span>
                                            </label>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <button
                                    ...
                                    className={`w-full lg:w-auto px-8 py-4 rounded-2xl font-black uppercase tracking-widest transition-all text-xs border ${
                                        selectedScreen.ticker?.isActive 
                                            ...
                                            : 'bg-white shadow-sm border-slate-300 text-zinc-500 hover:bg-slate-100 hover:text-zinc-900'
                                    }`}
                                >
                        ...
                        <div className="bg-white shadow-sm border border-slate-200 p-6 lg:p-8 rounded-3xl shadow-2xl mb-12">
                            <div className="flex flex-col lg:flex-row gap-6 items-center justify-between">
                                <div className="flex-1 w-full">
                                    <h3 className="text-base font-black text-zinc-900 mb-1">Módulo de Fila de Atendimento</h3>
                                        ...
                                        return (
                                            <div key={block} className="bg-white shadow-sm border border-slate-300 p-4 rounded-2xl relative">
                                                <div className="flex items-center justify-between mb-3">
                                                    <h4 className="font-bold text-zinc-900 text-sm truncate pr-2" title={block}>📁 {block}</h4>
                                                    <AnimatePresence>
                                                ...
                                                <div className="flex items-center gap-4">
                                                    <div className="flex-1">
                                                        ...
                                                        <input 
                                                            ...
                                                            className="w-full bg-white shadow-sm border border-slate-300 rounded-xl px-3 py-2 focus:border-orange-500 transition-all outline-none text-zinc-900 text-xs"
                                                        />
                                                    </div>
                                                    <div className="flex-1">
